...
class HomeFragment : Fragment() {
    ...
    /*private fun inputDummyAlbums(){
        ...
        songDB.albumDao().apply{
            insert(Album(1,"Lilac","아이유 (IU)", R.drawable.img_album_exp2))
            insert(Album(2,"Flu","아이유 (IU)", R.drawable.img_album_exp2))
            insert(Album(3,"Butter","방탄소년단 (BTS)", R.drawable.img_album_exp))
            insert(Album(4,"Boy with Luv","방탄소년단 (BTS)", R.drawable.justin))
            insert(Album(5,"Next level","에스파", R.drawable.hezie))
        }
    }*/
}
