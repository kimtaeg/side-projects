package com.example.week9.ui.main

import UI.home.HomeFragment
import UI.locker.LockerFragment
import com.example.week9.ui.song.SongActivity
...
import com.example.week9.ui.look.LookFragment
import com.example.week9.service.MusicPlayer
import com.example.week9.R
import com.example.week9.ui.fragment.SearchFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.mainMiniplayerBtn.setOnClickListener {
            ...
            // ⭐ 디버깅 로그 추가: 서비스로 전달되는 값을 확인합니다.
            Log.d("MINI_PLAYER_DEBUG", "Command: play, Music: ${song.music}, Second: ${song.second}")
...
//BottomNavigationView를 눌렀을 때 Fragment 변경하기
    ...
    override fun onResume() {
        ...
        ContextCompat.registerReceiver(
            ...
            musicPlayerReceiver,
            filter,
            ContextCompat.RECEIVER_EXPORTED // 외부 앱에서도 Broadcast를 받을 수 있도록 플래그 설정
        )
        song = if (songId == 0) {
